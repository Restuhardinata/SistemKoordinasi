...
public class EvaluasiActivity extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listSoal = new ArrayList<Evaluasi>();
        listSoal = db.getSoal();
    ...
    private void showInputUser() {
        ...
        dialog.setIcon(R.drawable.learn);
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            tampilKotakAlert = new AlertDialog.Builder(getApplicationContext()).create();
            ...
            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEUTRAL, "Lagi",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            noSalah="";
                            java.util.Arrays.fill(jawabanYgDiPilih, -2);
                            EvaluasiActivity.this.tunjukanPertanyaan(0,
                                    cekPertanyaan);
                        }
                    });
...
//            tampilKotakAlert.show();
        ...
        builder.setMessage("Do you really want to exit?").setCancelable(
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        EvaluasiActivity.this.finish();
                        Intent intent = new Intent(EvaluasiActivity.this, QuizActivity.class);
    ...
    private OnClickListener klikSelesai = new OnClickListener() {
        public void onClick(View v) {
            ...
            AlertDialog tampilKotakAlert;
            tampilKotakAlert = new AlertDialog.Builder(EvaluasiActivity.this).create();
            tampilKotakAlert.setTitle("Nilai");
            tampilKotakAlert.setMessage("Benar " +jumlahJawabanYgBenar + " dari "
                    + (listSoal.size() +" soal. "+noSalah));
